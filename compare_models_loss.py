# -*- coding: utf-8 -*-
"""
Runs the experiment performed in chapter 4.4.2 and plots figure 4.4
...
mode = 'loss'
max_epochs = 9000000
delta_threshold = 10e-8    #mode = 'loss' threshold
...
plt.xlabel('Epoch')
plt.ylabel("MSE")
plt.plot(bfgs20_loss, 'g-', label='BGFS-L (m = 20)')
plt.plot(bfgs50_loss, 'k-', label='BGFS-L (m = 50)')
plt.plot(bfgs100_loss, 'c-', label='BGFS-L (m = 100)')
plt.plot(bfgs500_loss, 'y-', label='BGFS-L (m = 500)')
plt.plot(adam_loss, 'r-', label='Adam')
plt.yscale("log")
